...
<required_reading>
Read `C:/Users/pedro/OneDrive/Documentos/projetos/automations/.claude/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
