...
<required_reading>
Read `C:/Users/pedro/OneDrive/Documentos/projetos/automations/.claude/get-shit-done/references/ai-evals.md` — specifically the rubric design and domain expert sections.
</required_reading>
