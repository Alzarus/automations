...
The keys live in `.claude/settings.json` (project) or `C:/Users/pedro/OneDrive/Documentos/projetos/automations/.claude/settings.json` (global) — **not** in `.planning/config.json`:
