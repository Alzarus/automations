...
```
Agent(
  prompt="Read C:/Users/pedro/OneDrive/Documentos/projetos/automations/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/pedro/OneDrive/Documentos/projetos/automations/.claude/get-shit-done/templates/SECURITY.md`
