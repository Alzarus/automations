...
```bash
INIT=$(node "C:/Users/pedro/OneDrive/Documentos/projetos/automations/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Users/pedro/OneDrive/Documentos/projetos/automations/.claude/get-shit-done/templates/spec.md.
